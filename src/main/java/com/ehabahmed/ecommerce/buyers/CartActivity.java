...
public class CartActivity extends AppCompatActivity {
    ...
    private TextView txttotalAmount, messageFinalOrder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageFinalOrder = (TextView) findViewById(R.id.message_final_order);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Cart> options = new FirebaseRecyclerOptions.Builder<Cart>()
                .setQuery(cartListRef.child("User View").child(Prevalent.CURRENT_ONLINE_USER.getPhone())
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if (which == 0) {
                                    ...
                                    cartListRef.child("User View").child(Prevalent.CURRENT_ONLINE_USER.getPhone())
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (shippingState.equals("shipped")) {
                        ...
                        messageFinalOrder.setVisibility(View.VISIBLE);
                        messageFinalOrder.setText("Congratulatios ,your final order has been Shipped successfully, Soon you will received your order at your door step.");
